...
export const REQUIRED_BEHAVIORS: RequiredBehavior[] = [
  ...
  { id: 'configuration.invalid-live-update', check: 'invalid live update retains last known-good', requirement: 'An invalid settings update keeps the last known-good configuration.' },
  ...
  { id: 'configuration.settings-read-after-good', check: 'settings read failure keeps last known-good configuration', requirement: 'A settings read failure after a valid config keeps the last known-good configuration.' },
